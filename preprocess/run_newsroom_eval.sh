...
# Generate summaries:
python multi_gpu_generate.py --base_dir <processed-data-dir> --output_dir <output-dir> --output_suffix ent_beam4 --checkpoint_dir <checkpoint_dir> --bin_dir <processed-data-dir>/entity_augment/data_bin --input_file val.source  --max_len 140 --min_len 10 --bsz 32 --checkpoint_num 12345678 --num_workers 4
