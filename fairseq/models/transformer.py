...
class TransformerModel(FairseqEncoderDecoderModel):
    ...
    def add_args(parser):
        ...
        parser.add_argument('--share-decoder-input-output-embed', type=options.str2bool, nargs='?', const=True, default=False,
                            help='share decoder input and output embeddings')
        parser.add_argument('--share-all-embeddings', type=options.str2bool, nargs='?', const=True, default=False,
        ...
        parser.add_argument('--decoder-layers-to-keep', default=None,
                            help='which layers to *keep* when pruning as a comma-separated list')
        parser.add_argument('--layernorm-embedding', type=options.str2bool, nargs='?', const=True, default=False,
