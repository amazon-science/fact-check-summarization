...
class RoundRobinZipDatasets(FairseqDataset):
    ...
    def ordered_indices(self):
        ...
        if self._ordered_indices is None:
            ...
            print("round_robin_zip_datasets ordered indices source-target: ", self._ordered_indices['source-target'][:10])
            print("round_robin_zip_datasets ordered indices source-untarget: ", self._ordered_indices['source-untarget'][:10])
