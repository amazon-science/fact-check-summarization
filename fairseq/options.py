...
def get_parser(desc, default_task="translation"):
    ...
    # fmt: off
    parser.add_argument('--no-progress-bar', type=str2bool, nargs='?', const=True, default=False,
    ...
    parser.add_argument('--cpu', type=str2bool, nargs='?', const=True, default=False, help='use CPU instead of CUDA')
    parser.add_argument('--fp16', type=str2bool, nargs='?', const=True, default=False, help='use FP16')
    parser.add_argument('--memory-efficient-fp16', type=str2bool, nargs='?', const=True, default=False,
                        help='use a memory-efficient version of FP16 training; implies --fp16')
    parser.add_argument('--fp16-no-flatten-grads', type=str2bool, nargs='?', const=True, default=False,
    ...
    parser.add_argument('--validation-only', type=str2bool, nargs='?', const=True, default=False,
...
def add_preprocess_args(parser):
    ...
    group.add_argument("--cls-suffix", metavar="FP", default=None,
                       help="classification label file suffix")
    group.add_argument("--cls-indices-suffix", metavar="FP", default=None,
                       help="classification indices file suffix")
    ...
    group.add_argument("--joined-dictionary", type=str2bool, nargs='?', const=True, default=False,
                       help="Generate joined dictionary")
    group.add_argument("--only-source", type=str2bool, nargs='?', const=True, default=False,
                       help="Only process the source language")
    group.add_argument("--only-target", type=str2bool, nargs='?', const=True, default=False,
                       help="Only binarize the target language")
    group.add_argument("--only-cls", type=str2bool, nargs='?', const=True, default=False,
                       help="Only process the classification labels")
...
def add_dataset_args(parser, train=False, gen=False):
    ...
    group.add_argument('--skip-invalid-size-inputs-valid-test', type=str2bool, nargs='?', const=True, default=False,
    ...
    if train:
        ...
        group.add_argument('--disable-validation', type=str2bool, nargs='?', const=True, default=False,
...
def add_distributed_training_args(parser):
    ...
    group.add_argument('--distributed-no-spawn', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--fix-batches-to-gpus', type=str2bool, nargs='?', const=True, default=False,
                       help='don\'t shuffle batches between GPUs; this reduces overall '
                            'randomness and may affect precision but avoids the cost of '
                            're-reading the data')
    group.add_argument('--find-unused-parameters', type=str2bool, nargs='?', const=True, default=False,
                       help='disable unused parameter detection (not applicable to '
                       'no_c10d ddp-backend')
    group.add_argument('--fast-stat-sync', type=str2bool, nargs='?', const=True, default=False,
                       help='[deprecated] this is now defined per Criterion')
    group.add_argument('--broadcast-buffers', type=str2bool, nargs='?', const=True, default=False,
...
def add_optimization_args(parser):
    ...
    group.add_argument('--sentence-avg', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--use-bmuf', type=str2bool, nargs='?', const=True, default=False,
...
def add_checkpoint_args(parser):
    ...
    group.add_argument('--reset-dataloader', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, does not reload dataloader state from the checkpoint')
    group.add_argument('--reset-lr-scheduler', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, does not load lr scheduler state from the checkpoint')
    group.add_argument('--reset-meters', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, does not load meters from the checkpoint')
    group.add_argument('--reset-optimizer', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--no-save', type=str2bool, nargs='?', const=True, default=False,
                       help='don\'t save models or checkpoints')
    group.add_argument('--no-epoch-checkpoints', type=str2bool, nargs='?', const=True, default=False,
                       help='only store last and best checkpoints')
    group.add_argument('--no-last-checkpoints', type=str2bool, nargs='?', const=True, default=False,
                       help='don\'t store last checkpoints')
    group.add_argument('--no-save-optimizer-state', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--maximize-best-checkpoint-metric', type=str2bool, nargs='?', const=True, default=False,
...
def add_common_eval_args(group):
    ...
    group.add_argument('--quiet', type=str2bool, nargs='?', const=True, default=False,
...
def add_eval_lm_args(parser):
    ...
    add_common_eval_args(group)
    # fmt: off
    group.add_argument('--output-word-probs', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, outputs words and their predicted log probabilities to standard output')
    group.add_argument('--output-word-stats', type=str2bool, nargs='?', const=True, default=False,
...
def add_generation_args(parser):
    ...
    group.add_argument('--match-source-len', type=str2bool, nargs='?', const=True, default=False,
                       help=('generations should match the source length'))
    group.add_argument('--no-early-stop', type=str2bool, nargs='?', const=True, default=False,
                       help='deprecated')
    group.add_argument('--unnormalized', type=str2bool, nargs='?', const=True, default=False,
                       help='compare unnormalized hypothesis scores')
    group.add_argument('--no-beamable-mm', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--sacrebleu', type=str2bool, nargs='?', const=True, default=False,
                       help='score with sacrebleu')
    group.add_argument('--score-reference', type=str2bool, nargs='?', const=True, default=False,
                       help='just score the reference translation')
    group.add_argument('--prefix-size', default=0, type=int, metavar='PS',
                       help='initialize generation by target prefix of given length')
    group.add_argument('--no-repeat-ngram-size', default=0, type=int, metavar='N',
                       help='ngram blocking such that this size ngram cannot be repeated in the generation')
    group.add_argument('--sampling', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--print-alignment', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, uses attention feedback to compute and print alignment to source tokens')
    group.add_argument('--print-step', type=str2bool, nargs='?', const=True, default=False)
    ...
    group.add_argument('--iter-decode-force-max-iter', type=str2bool, nargs='?', const=True, default=False,
    ...
    group.add_argument('--iter-decode-with-external-reranker', type=str2bool, nargs='?', const=True, default=False,
                       help='if set, the last checkpoint are assumed to be a reranker to rescore the translations'),
    group.add_argument('--retain-iter-history', type=str2bool, nargs='?', const=True, default=False,
