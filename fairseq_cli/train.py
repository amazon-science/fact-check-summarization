...
# added for sagemaker:
# https://github.com/awslabs/amazon-sagemaker-examples/blob/master/advanced_functionality/fairseq_translation/fairseq/train
import os
import copy
import sys
...
def main(args, init_distributed=False):
    ...
    while (
        ...
        # logger.info("DEBUG: going into trainer.get_train_iterator!")
        epoch_itr = trainer.get_train_iterator(
            epoch_itr.next_epoch_idx,
            # sharded data: get train iterator for next epoch
            load_dataset=(os.pathsep in getattr(args, 'data', '')),
        )
        # logger.info("DEBUG: out of trainer.get_train_iterator!")
    train_meter.stop()
